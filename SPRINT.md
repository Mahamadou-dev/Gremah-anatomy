...
| 13     | 🟨 en cours | `sprint-13/compte`       | Suppression (avec effacement des compteurs de débit), export JSON, modification de profil, pages légales bilingues FR/EN. Reste : réinitialisation de mot de passe, vérification d'adresse, envoi d'email (bloqué sur le mot de passe d'application Gmail), UI de la page de profil.                                                   |
