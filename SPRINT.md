...
>
> **Dernière vérification :** 22 août 2026. Sprint 14 clos et **fusionné sur `main`** (PR #1). Sprint 15 clos partiel et **fusionné sur `main`** (PR #2) — reste honnête : routage par préfixe d'URL, extraction complète des chaînes d'interface, zarma. Sprint en cours : **16** (`sprint-16/interaction`).
